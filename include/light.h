...
class Light {
 public:
  ...
  [[nodiscard]] virtual Vec3f sample(Interaction &interaction, Sampler &sampler) const = 0;
...
class SquareAreaLight : public Light {
 public:
  ...
  [[nodiscard]] Vec3f sample(Interaction &interaction, Sampler &sampler) const override;
