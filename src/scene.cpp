...
#define NURBS_MESH
      ...
      // Generate mesh on NURBS
      {
        ...
        tmpDuck1->setKnotM({-1.5708, -1.5708, -1.5708, -1.5708, -1.0472,
                            -0.523599, 0, 0.523599, 0.808217, 1.04015, 1.0472,
                            1.24824, 1.29714, 1.46148, 1.5708, 1.5708, 1.5708,
                            1.5708});
        tmpDuck1->setKnotN({-3.14159, -3.14159, -3.14159, -3.14159, -2.61799,
                            -2.0944, -1.0472, -0.523599, 6.66134e-016, 0.523599,
        ...
        tmpDuck2->setKnotM({0, 0, 0, 0, 0.145456, 0.265731, 0.436096, 0.583258,
                            0.847704, 1, 1, 1, 1});
        tmpDuck2->setKnotN({0, 0, 0, 0, 0.179541, 0.317924, 0.485586, 0.507528,
...
#else
      {
        std::shared_ptr<NURBS> tmpDuck1 = std::make_shared<NURBS>(
            ...
            std::vector<float>({-1.5708, -1.5708, -1.5708, -1.5708, -1.0472,
            ...
            std::vector<float>({-3.14159, -3.14159, -3.14159, -3.14159,
                                ...
                                6.66134e-016, 0.523599, 1.0472, 2.0944, 2.61799,
